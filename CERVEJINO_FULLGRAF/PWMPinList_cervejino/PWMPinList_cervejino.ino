...
M2tk m2(&top_el_pin_list, m2_es_arduino_rotary_encoder, m2_eh_4bs, m2_gh_u8g_fb);

//=================================================
// array for the pwm information of all pwm pins 

// array with all the information
#define PWM_PIN_CNT 2
uint8_t pwm_duty_array[PWM_PIN_CNT] = { 0,0 };
uint8_t pwm_pin_array[PWM_PIN_CNT] = { 1,2 };
...
M2_LABEL(el_pwm_pin_label, NULL, "Fermentador:");
M2_U8NUM(el_pwm_pin_num, "r1c2", 0, 255, &pwm_menu_pin);

//M2_LABEL(el_pwm_pin_label2, NULL, "Maturador:");
//M2_U8NUM(el_pwm_pin_num, "r1c2", 0, 255, &pwm_menu_pin);

// the duty field can be changed by the user
M2_LABEL(el_pwm_duty_label, NULL, "Graus: ");
