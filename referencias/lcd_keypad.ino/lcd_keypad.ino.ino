...
/*
 ...
 and produces a 3 digit integer number displayed on the LCD serial screen.
...
const int rowPins[numRows] = { 
  22, 23, 24, 25, 26 }; // Rows 0 through 4
const int colPins[numCols] = { 
  27, 28, 29, 30 };    // Columns 0 through 3
